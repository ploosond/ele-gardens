...
const Footer = () => {
  return (
    <footer>
      <div className="my-10 flex flex-col gap-6 px-4 text-sm sm:grid-cols-[3fr_1fr_1fr] sm:px-8 md:grid md:px-16 lg:px-32 xl:px-64">
        <div>
          <img src={logo} alt="logo" className="mb-5 w-32" />
          <p className="text-justify text-gray-600 md:w-3/4">
        ...
        <div>
          <p className="mb-4 text-lg font-medium text-gray-800">Get in Touch</p>
          <ul className="space-y-2 text-gray-600">
            <li>
